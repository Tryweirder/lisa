...
class VmBus:
    ...
    def parse(self, raw_str: str) -> Any:
        ...
        for channel in raw_channels:
            ...
            assert matched_channel, "matched_channel should not be empty"
